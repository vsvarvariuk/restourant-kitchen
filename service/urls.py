...
urlpatterns = [
   ...
   path("dishtype-detail/<int:pk>/", DishTypeDetailView.as_view(), name="dishtype-detail"),
   path("dishtype-delete/<int:pk>/", DishTypeDeleteView.as_view(), name="dishtype-delete"),
